module.exports = {
  ...
  Token: process.env.Token || "MTA5ODgxNTg5ODI1NDU5NDEzOA.GmzzZK.6e471X1ORb6GacJOVgRhpA4_AIvy7zyzAn3MD4", // Discord Bot Token
  ClientID: process.env.Discord_ClientID || "1098815898254594138", // Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "kErzcDNGHx50IWbFqeLwtCblpQ6aNcf0", // Discord Client Secret
  ...
  Spotify: {
    ClientID: process.env.Spotify_ClientID || "6c31645ffb004ab8b44d06f7b96d1b66", // Spotify Client ID
    ClientSecret: process.env.Spotify_ClientSecret || "3618fdc0b4824cfd91a8d425dac32987", // Spotify Client Secret
  },
};
